...
public class Events : MonoBehaviour
{
    ...
    public void Gorbachev(){
        g.QuestNow="Gorbachev";
        QuestTitle="Вопрос Горбачева";
        QuestText="Поведения президента СССР после путча оканчательно обрушило то немного доверие, которое к нему оставалось. Как можно было ухать отдыхать, когда толпы Москвичей у Белого дома"+
        " ждали благодарности от того, кого они собственно спасали, в кого верили... "
        +"Сейчас же надо продумать линию поведения относительно этой персоны. Полномочий у него мало, лидер он лишь формальный. Можно продолжить сотрудничество с ним, пытаясь подписать новый союзный договор и используя его как посредника между республиками."+
        " А можно призвать его к отставке и попытаться занять пост президента СССР, совместив его с управлением Россией. Это подорвет доверие многих, но даст еще больше рычагов для управления страной";
        ImageSprite = Resources.Load<Sprite>("EventImages/Special_Belovej");
        //Общее для всех вариантов
        ...
        DisionText[b]="Продолжаем сотрудничество";
        DisionTip[b]="+Популярность";
        DisionReq[b]="";
        DisionLead[b]="Gorbachev1"; 

        b+=1;
        DisionText[b]="Призываем к отставке и предлагаем провести выборы";
        DisionTip[b]="-Популяность у всех, начинает цепочку на становление руководителем СССР. ";
        DisionReq[b]="Спасать союз";
        DisionLead[b]="Gorbachev2"; 
